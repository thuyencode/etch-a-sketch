export const gridContainer =
  document.querySelector<HTMLDivElement>('#grid-container')

export const hsColorInput =
  document.querySelector<HTMLInputElement>('#hs-color-input')

export const hsColorInputLabel = document.querySelector<HTMLInputElement>(
